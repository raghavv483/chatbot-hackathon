#!/usr/bin/env python3
"""
Walmart RAG System - Optimized Version
A Retrieval-Augmented Generation system for Walmart product data with comprehensive error handling and performance optimization.
"""
...
import json
# Static imports for all required libraries
import pandas as pd
import numpy as np
...
class WalmartRAGSystem:
    """Optimized Walmart RAG System with comprehensive error handling and performance monitoring."""
    ...
    def _clean_data(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        # Ensure numeric columns are numeric and fillna only on Series
        for col in ['price', 'discount', 'stock_quantity']:
...
"""
    ...
    def query_rag_system(self, query: str, n_results: int = 5, filters: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        if not self.model or not self.collection:
            print("✗ No model or collection available")
    ...
    def print_system_summary(self):
        ...
        if self.performance_metrics:
            ...
            for func_name, duration in self.performance_metrics.items():
...
def main():
    ...
    print("🛒 Walmart RAG System - Optimized Version")
    print("=" * 50)
    ...
    if not rag_system.generate_embeddings():
    ...
    if not rag_system.add_documents_to_collection():
